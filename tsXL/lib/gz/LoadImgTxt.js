var UpLoadImgTxt = (function () {
    function UpLoadImgTxt(imgPath, $txt) {
        this.$div = $('<div class="input-group"></div');
        if ($txt.length == 0)
            return;
        if ($txt.length > 1) {
    ...
    UpLoadImgTxt.prototype.BindUpLoadBtnEvent = function ($txt) {
        //webuploader 实例
    ...
    UpLoadImgTxt.prototype.newGiud = function () {
