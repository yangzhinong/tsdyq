                      ...
                      if (a(k).isVisible()) {
                          if (n == "radio" || n == "checkbox") {
                              ...
                              if (s == "select" || s == "empty") {
                                  ...
                                  if (/^range|number$/i.test(n) && $.isNumeric(k.value)) {
                                      //yzn change 增加友好提示  a=jQuery=$;
                                      var sprompt = '值无效';
                                      if (k.pattern && a(k).attr('data-msg-pattern')) {
                                          var oReg = new RegExp(k.pattern);

                                          if (!oReg.test(k.value)) {
                                              //没通过测试
                                              sprompt = a(k).attr('data-msg-pattern');
                                          }
                                      }
                                      //yzn change done

                                      a(k).testRemind(sprompt);
                                      k.focus();
                                      k.select()
                                  } else {
