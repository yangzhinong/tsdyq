define(function () {
    ...
    var a, i, s, l = function () { a = document.createElement("style"), e.appendChild(a), i = a.styleSheet || a.sheet; }, u = 0, d = [], c = function (e) { u++, 32 == u && (l(), u = 0), i.addImport(e), a.onload = function () { f(); }; }, f = function () { s(); var e = d.shift(); return e ? (s = e[1], void c(e[0])) : void (s = null); }, h = function (e, t) {
        ...
        if (o.type = "text/css", o.rel = "stylesheet", r)
            o.onload = function () { o.onload = function () { }, setTimeout(n, 7); };
        else
    ...
    return o.normalize = function (e, t) { return ".css" == e.substr(e.length - 4, 4) && (e = e.substr(0, e.length - 4)), t(e); }, o.load = function (e, t, r) { (n ? h : p)(t.toUrl(e + ".css"), r); }, o;
});
