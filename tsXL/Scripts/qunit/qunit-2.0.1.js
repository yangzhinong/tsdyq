...
(function (global) {
    ...
    function registerLoggingCallbacks(obj) {
        var i, l, key, callbackNames = ["begin", "done", "log", "testStart", "testDone",
    ...
    extend(QUnit, {
        ...
        module: function (name, testEnvironment, executeNow) {
            ...
            if (testEnvironment && (testEnvironment.setup || testEnvironment.teardown)) {
                console.warn("Module's `setup` and `teardown` are not hooks anymore on QUnit 2.0, use " +
        ...
        start: function (count) {
            ...
            if (!config.current) {
                ...
                throw new Error("QUnit.start cannot be called inside a test context. This feature is removed in " +
    ...
    var unitSampler, focused = false, priorityCount = 0;
        ...
        resolvePromise: function (promise, phase) {
            ...
            if (promise != null) {
                ...
                if (QUnit.objectType(then) === "function") {
                    ...
                    then.call(promise, function () { resume(); }, function (error) {
    ...
    QUnit.assert = Assert.prototype = {
        ...
        async: function (count) {
            var resume, test = this.test, popped = false, acceptCallCount = count;
...
(function () {
    ...
    var config = QUnit.config, document = window.document, collapseNext = false, hasOwn = Object.prototype.hasOwnProperty, unfilteredUrl = setUrl({ filter: undefined, module: undefined,
        moduleId: undefined, testId: undefined }), defined = {
        sessionStorage: (function () {
            var x = "qunit-test-string";
            try {
                sessionStorage.setItem(x, x);
...
//# sourceMappingURL=qunit-2.0.1.js.map 
//# sourceMappingURL=qunit-2.0.1.js.map 
//# sourceMappingURL=qunit-2.0.1.js.map 
//# sourceMappingURL=qunit-2.0.1.js.map 
//# sourceMappingURL=qunit-2.0.1.js.map 
