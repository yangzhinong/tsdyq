...
(function () {
    ...
    function K(v) {
        function ga(a, d, c, e, f) { var g = [], a = b.j(function () { var a = d(c, f) || []; 0 < g.length && (b.a.Xa(L(g), a), e && b.r.K(e, n, [c, a, f])); g.splice(0, g.length); b.a.P(g, a); }, n, { W: a, Ja: function () { return 0 == g.length || !b.a.X(g[0]); } }); return { M: g, j: a.oa() ? a : H }; }
        function L(a) {
        ...
        function Z(a, b) { var c = $(a, b); return c ? 0 < c.length ? c[c.length - 1].nextSibling : a.nextSibling : n; }
        function $(a, b) {
        ...
        function O(a, b) {
            for (var c = n; a != c;)
                c = a, a = a.replace(ja, function (a, c) { return b[c]; });
            return a;
        }
        function ka() { var a = [], d = []; this.save = function (c, e) { var f = b.a.i(a, c); 0 <= f ? d[f] = e : (a.push(c), d.push(e)); }; this.get = function (c) { c = b.a.i(a, c); return 0 <= c ? d[c] : H; }; }
        function aa(a, b, c) {
            function e(e) {
                var g = b(a[e]);
                switch (typeof g) {
        ...
        function P(a, d, c, e) {
            b.c[a] = { init: function (a) { b.a.f.set(a, ca, {}); return { controlsDescendantBindings: l }; }, update: function (a, g, h, j, k) {
        ...
        function da(a, d, c) { c && d !== b.k.q(a) && b.k.T(a, d); d !== b.k.q(a) && b.r.K(b.a.Aa, n, [a, "change"]); }
            ...
            return { Ma: ["authenticity_token", /^__RequestVerificationToken(_.*)?$/], o: function (a, b) {
                    ...
                    for (var c = 0, e = a.length; c < e; c++)
                        if (b.call(d, a[c]))
                            return a[c];
                    return n;
                }, ga: function (a, d) { var c = b.a.i(a, d); 0 <= c && a.splice(c, 1); }, Fa: function (a) {
                ...
                Xa: function (a, d) {
                ...
                }, ab: function (a, b) { 7 > m ? a.setAttribute("selected", b) : a.selected = b; }, D: function (a) { return (a || "").replace(d, ""); }, Qb: function (a, d) {
                    for (var c = [], e = (a || "").split(d), f = 0, g = e.length; f < g; f++) {
                        var h = b.a.D(e[f]);
                        "" !== h && c.push(h);
                    }
                    return c;
                }, Nb: function (a, b) { a = a || ""; return b.length > a.length ? q : a.substring(0, b.length) === b; }, sb: function (a, b) {
                    ...
                    if (!e && "undefined" != typeof E) {
                        if (a(b, d))
                            var f = c, c = function (a, b) { var d = this.checked; b && (this.checked = b.mb !== l); f.call(this, a); this.checked = d; };
                        E(b).bind(d, c);
                    }
                    else
                ...
                }, d: function (a) { return b.$(a) ? a() : a; }, ta: function (a) { return b.$(a) ? a.t() : a; }, da: function (a, d, c) {
                    if (d) {
                        var e = /[\w-]+/g, f = a.className.match(e) || [];
                        b.a.o(d.match(e), function (a) { var d = b.a.i(f, a); 0 <= d ? c || f.splice(d, 1) : c && f.push(a); });
                        a.className = f.join(" ");
                    }
                }, bb: function (a, d) {
                    var c = b.a.d(d);
                ...
                }, vb: function (a) { 9 <= m && (a = 1 == a.nodeType ? a : a.parentNode, a.style && (a.style.zoom = a.style.zoom)); }, tb: function (a) {
                    if (9 <= m) {
                        var b = a.style.width;
                        a.style.width = 0;
                        a.style.width = b;
                    ...
                    for (var c = b.a.L(a.getElementsByTagName("input")).concat(b.a.L(a.getElementsByTagName("textarea"))), e = "string" == typeof d ? function (a) { return a.name === d; } : function (a) { return d.test(a.name); }, f = [], g = c.length - 1; 0 <= g; g--)
                        e(c[g]) && f.push(c[g]);
                    return f;
                }, Hb: function (a) { return "string" == typeof a && (a = b.a.D(a)) ? w.JSON && w.JSON.parse ? w.JSON.parse(a) : (new Function("return " + a))() : n; }, wa: function (a, d, c) {
        ...
        Function.prototype.bind || (Function.prototype.bind = function (a) { var b = this, c = Array.prototype.slice.call(arguments), a = c.shift(); return function () { return b.apply(a, c.concat(Array.prototype.slice.call(arguments))); }; });
        b.a.f = new function () {
            var a = 0, d = "__ko__" + (new Date).getTime(), c = {};
            return { get: function (a, d) { var c = b.a.f.getAll(a, q); return c === H ? H : c[d]; }, set: function (a, d, c) { c === H && b.a.f.getAll(a, q) === H || (b.a.f.getAll(a, l)[d] = c); }, getAll: function (b, f) {
                    var g = b[d];
                    if (!g || !("null" !== g && c[g])) {
                        if (!f)
                            return H;
        ...
        b.a.F = new function () {
            function a(a, d) { var e = b.a.f.get(a, c); e === H && d && (e = [], b.a.f.set(a, c, e)); return e; }
            function d(c) {
                var e = a(c, q);
                if (e)
            ...
            return { Ba: function (b, d) { "function" != typeof d && i(Error("Callback must be a function")); a(b, l).push(d); }, Wa: function (d, e) { var f = a(d, q); f && (b.a.ga(f, e), 0 == f.length && b.a.f.set(d, c, H)); }, A: function (a) {
        ...
        var Q = {};
        b.s = { qa: function (a) { "function" != typeof a && i(Error("You can only pass a function to ko.memoization.memoize()")); var b = (4294967296 * (1 + Math.random()) | 0).toString(16).substring(1) + (4294967296 * (1 + Math.random()) | 0).toString(16).substring(1); Q[b] = a; return "<\!--[ko_memo:" + b + "]--\>"; }, gb: function (a, b) {
                var c = Q[a];
        ...
        b.La = { throttle: function (a, d) { a.throttleEvaluation = d; var c = n; return b.j({ read: a, write: function (b) { clearTimeout(c); c = setTimeout(function () { a(b); }, d); } }); }, notify: function (a, d) { a.equalityComparer = "always" == d ? t(q) : b.m.fn.equalityComparer; return a; } };
        b.b("extenders", b.La);
        b.eb = function (a, d, c) { this.target = a; this.ha = d; this.qb = c; b.p(this, "dispose", this.B); };
        b.eb.prototype.B = function () { this.Bb = l; this.qb(); };
        b.S = function () {
            this.w = {};
        ...
        b.S.fn = { xa: function (a, d, c) { var c = c || "change", a = d ? a.bind(d) : a, e = new b.eb(this, a, function () { b.a.ga(this.w[c], e); }.bind(this)); this.w[c] || (this.w[c] = []); this.w[c].push(e); return e; }, notifySubscribers: function (a, d) { d = d || "change"; this.w[d] && b.r.K(function () { b.a.o(this.w[d].slice(0), function (b) { b && b.Bb !== l && b.ha(a); }); }, this); }, xb: function () {
                var a = 0, b;
                for (b in this.w)
        ...
        var B = [];
        b.r = { lb: function (a) { B.push({ ha: a, Ka: [] }); }, end: function () { B.pop(); }, Va: function (a) {
        ...
        b.a.o("pop push reverse shift sort splice unshift".split(" "), function (a) { b.R.fn[a] = function () { var b = this.t(); this.H(); b = b[a].apply(b, arguments); this.G(); return b; }; });
        b.a.o(["slice"], function (a) { b.R.fn[a] = function () { var b = this(); return b[a].apply(b, arguments); }; });
        b.b("observableArray", b.R);
        b.j = function (a, d, c) {
            function e() { b.a.o(y, function (a) { a.B(); }); y = []; }
            function f() { var a = h.throttleEvaluation; a && 0 <= a ? (clearTimeout(s), s = setTimeout(g, a)) : g(); }
            function g() {
                if (!p)
                    if (m && v())
                        z();
                        ...
                        try {
                            ...
                            b.r.lb(function (c) { var d; 0 <= (d = b.a.i(a, c)) ? a[d] = H : y.push(c.xa(f)); });
            ...
            if (F && j()) {
                z = function () { b.a.F.Wa(F, arguments.callee); e(); };
                b.a.F.Ba(F, z);
        ...
        b.toJSON = function (a, d, c) { a = b.fb(a); return b.a.wa(a, d, c); };
        b.b("toJS", b.fb);
        b.b("toJSON", b.toJSON);
        b.k = { q: function (a) {
                switch (b.a.u(a)) {
                    ...
                    case "select": return 0 <= a.selectedIndex ? b.k.q(a.options[a.selectedIndex]) : H;
                    ...
                    case "option":
                        switch (typeof d) {
                            case "string":
                                ...
                                a.value = d;
                                break;
                            default: b.a.f.set(a, b.c.options.ra, d), a.__ko__hasDomDataOptionValue__ = l, a.value = "number" === typeof d ?
                                d : "";
                        }
                        break;
                    case "select":
        ...
        var J = "<\!--test--\>" === x.createComment("test").text, ia = J ? /^<\!--\s*ko(?:\s+(.+\s*\:[\s\S]*))?\s*--\>$/ : /^\s*ko(?:\s+(.+\s*\:[\s\S]*))?\s*$/, ha = J ? /^<\!--\s*\/ko\s*--\>$/ :
            /^\s*\/ko\s*$/, oa = { ul: l, ol: l };
        b.e = { I: {}, childNodes: function (a) { return A(a) ? $(a) : a.childNodes; }, Y: function (a) {
                if (A(a))
                ...
                if (A(a)) {
                    ...
                    b.a.N(a, d);
            }, Ua: function (a, b) { A(a) ? a.parentNode.insertBefore(b, a.nextSibling) : a.firstChild ? a.insertBefore(b, a.firstChild) : a.appendChild(b); }, Oa: function (a, d, c) {
        ...
        b.a.extend(b.J.prototype, { nodeHasBindings: function (a) {
                switch (a.nodeType) {
                    case 1: return a.getAttribute("data-bind") !=
                        n;
                    case 8: return b.e.ib(a) != n;
                    default: return q;
                }
            }, getBindings: function (a, b) { var c = this.getBindingsString(a, b); return c ? this.parseBindingsString(c, b, a) : n; }, getBindingsString: function (a) {
                switch (a.nodeType) {
                    case 1: return a.getAttribute("data-bind");
                    case 8: return b.e.ib(a);
                    default: return n;
                }
        ...
        b.c = {};
        b.z = function (a, d, c) { d ? (b.a.extend(this, d), this.$parentContext = d, this.$parent = d.$data, this.$parents = (d.$parents || []).slice(0), this.$parents.unshift(this.$parent)) : (this.$parents = [], this.$root = a, this.ko = b); this.$data = a; c && (this[c] = a); };
        b.z.prototype.createChildContext = function (a, d) { return new b.z(a, this, d); };
        b.z.prototype.extend = function (a) { var d = b.a.extend(new b.z, this); return b.a.extend(d, a); };
        b.cb = function (a, d) {
            if (2 ==
                arguments.length)
        ...
        b.Ea = function (a, d, c) { 1 === a.nodeType && b.e.Sa(a); return W(a, d, c, l); };
        b.Da = function (a, b) { (1 === b.nodeType || 8 === b.nodeType) && Y(a, b, l); };
        b.Ca = function (a, b) { b && (1 !== b.nodeType && 8 !== b.nodeType) && i(Error("ko.applyBindings: first parameter should be your view model; second parameter should be a DOM node")); b = b || w.document.body; X(a, b, l); };
        b.ja = function (a) {
            switch (a.nodeType) {
                case 1:
                case 8:
        ...
        b.c.enable = { update: function (a, d) { var c = b.a.d(d()); c && a.disabled ? a.removeAttribute("disabled") : !c && !a.disabled && (a.disabled = l); } };
        ...
        P("if");
        P("ifnot", q, l);
        P("with", l, q, function (a, b) { return a.createChildContext(b); });
        b.c.options = { update: function (a, d, c) {
                "select" !== b.a.u(a) && i(Error("options binding applies only to SELECT elements"));
                for (var e = 0 == a.length, f = b.a.V(b.a.fa(a.childNodes, function (a) { return a.tagName && "option" === b.a.u(a) && a.selected; }), function (a) { return b.k.q(a) || a.innerText || a.textContent; }), g = a.scrollTop, h = b.a.d(d()); 0 < a.length;)
                ...
                if (h) {
                    ...
                    for (var d = 0, m = h.length; d < m; d++) {
                        var p = h[d];
                        if (!p || !p._destroy || j) {
                            var k = x.createElement("option"), r = function (a, b, c) { var d = typeof b; return "function" == d ? b(a) : "string" == d ? a[b] : c; }, u = r(p, c.optionsValue, p);
                            b.k.T(k, b.a.d(u));
        ...
        b.c.selectedOptions = { init: function (a, d, c) { b.a.n(a, "change", function () { var e = d(), f = []; b.a.o(a.getElementsByTagName("option"), function (a) { a.selected && f.push(b.k.q(a)); }); b.g.ea(e, c, "value", f); }); }, update: function (a, d) { "select" != b.a.u(a) && i(Error("values binding applies only to SELECT elements")); var c = b.a.d(d()); c && "number" == typeof c.length && b.a.o(a.getElementsByTagName("option"), function (a) { var d = 0 <= b.a.i(c, b.k.q(a)); b.a.ab(a, d); }); } };
        ...
        b.c.value = { init: function (a, d, c) {
                function e() { h = q; var e = d(), f = b.k.q(a); b.g.ea(e, c, "value", f); }
                ...
                if (b.a.Z && ("input" == a.tagName.toLowerCase() && "text" == a.type && "off" != a.autocomplete && (!a.form || "off" != a.form.autocomplete)) && -1 == b.a.i(f, "propertychange"))
                    b.a.n(a, "propertychange", function () { h = l; }), b.a.n(a, "blur", function () { h && e(); });
                b.a.o(f, function (c) {
                    var d = e;
        ...
        b.c.visible = { update: function (a, d) { var c = b.a.d(d()), e = "none" != a.style.display; c && !e ? a.style.display = "" : !c && e && (a.style.display = "none"); } };
        b.c.click = { init: function (a, d, c, e) { return b.c.event.init.call(this, a, function () { var a = {}; a.click = d(); return a; }, c, e); } };
        b.v = function () { };
        ...
        b.v.prototype.rewriteTemplate = function (a, b, c) { a = this.makeTemplateSource(a, c); b = b(a.text()); a.text(b); a.data("isRewritten", l); };
        b.b("templateEngine", b.v);
        var pa = /(<[a-z]+\d*(\s+(?!data-bind=)[a-z0-9\-]+(=(\"[^\"]*\"|\'[^\']*\'))?)*\s+)data-bind=(["'])([\s\S]*?)\5/gi, qa = /<\!--\s*ko\b\s*([\s\S]*?)\s*--\>/g;
        b.ya = { ub: function (a, d, c) { d.isTemplateRewritten(a, c) || d.rewriteTemplate(a, function (a) { return b.ya.Fb(a, d); }, c); }, Fb: function (a, b) { return a.replace(pa, function (a, e, f, g, h, j, k) { return V(k, e, b); }).replace(qa, function (a, e) { return V(e, "<\!-- ko --\>", b); }); }, jb: function (a) { return b.s.qa(function (d, c) { d.nextSibling && b.Ea(d.nextSibling, a, c); }); } };
        ...
        var N;
        b.va = function (a) { a != H && !(a instanceof b.v) && i(Error("templateEngine must inherit from ko.templateEngine")); N = a; };
        b.ua = function (a, d, c, e, f) {
            ...
            if (e) {
                var g = M(e);
                return b.j(function () { var h = d && d instanceof b.z ? d : new b.z(b.a.d(d)), j = "function" == typeof a ? a(h.$data, h) : a, h = S(e, f, j, h, c); "replaceNode" == f && (e = h, g = M(e)); }, n, { Ja: function () { return !g || !b.a.X(g); }, W: g && "replaceNode" == f ? g.parentNode : g });
            }
            return b.s.qa(function (e) { b.ua(a, d, c, e, "replaceNode"); });
        };
        b.Lb = function (a, d, c, e, f) {
            function g(a, b) { T(b, j); c.afterRender && c.afterRender(b, a); }
            function h(d, e) {
            ...
            var j;
            return b.j(function () { var a = b.a.d(d) || []; "undefined" == typeof a.length && (a = [a]); a = b.a.fa(a, function (a) { return c.includeDestroyed || a === H || a === n || !b.a.d(a._destroy); }); b.r.K(b.a.Za, n, [e, a, h, c, g]); }, n, { W: e });
        };
        ...
        b.a.Ia = function (a, b, c) { a = a || []; b = b || []; return a.length <= b.length ? R(a, b, "added", "deleted", c) : R(b, a, "deleted", "added", c); };
        b.b("utils.compareArrays", b.a.Ia);
        b.a.Za = function (a, d, c, e, f) {
            function g(a, b) { s = k[b]; v !== b && (y[a] = s); s.ma(v++); L(s.M); r.push(s); z.push(s); }
            function h(a, c) {
                if (a)
                    for (var d = 0, e = c.length; d < e; d++)
                        c[d] && b.a.o(c[d].M, function (b) { a(b, d, c[d].U); });
            }
            for (var d = d || [], e = e || {}, j = b.a.f.get(a, "setDomNodeChildrenFromArrayMapping_lastMappingResult") === H, k = b.a.f.get(a, "setDomNodeChildrenFromArrayMapping_lastMappingResult") || [], m = b.a.V(k, function (a) { return a.U; }), p = b.a.Ia(m, d), r = [], u = 0, v = 0, A = [], z = [], d = [], y = [], m = [], s, C = 0, B, D; B = p[C]; C++)
                switch (D = B.moved, B.status) {
                    ...
                    case "retained":
                        g(C, u++);
                        break;
                    case "added": D !== H ? g(C, D) : (s = { U: B.value, ma: b.m(v++) }, r.push(s), z.push(s), j || (m[C] = s));
                }
            h(e.beforeMove, y);
...
//# sourceMappingURL=knockout-2.2.0.js.map 
//# sourceMappingURL=knockout-2.2.0.js.map 
//# sourceMappingURL=knockout-2.2.0.js.map 
//# sourceMappingURL=knockout-2.2.0.js.map 
//# sourceMappingURL=knockout-2.2.0.js.map 
