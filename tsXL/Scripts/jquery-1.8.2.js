...
(function (window, undefined) {
    ...
    rdisplayswap = /^(none|table(?!-c[ea]).+)/, rmargin = /^margin/, rnumsplit = new RegExp("^(" + core_pnum + ")(.*)$", "i"), rnumnonpx = new RegExp("^(" + core_pnum + ")(?!px)[a-z%]+$", "i"), rrelNum = new RegExp("^([-+])=(" + core_pnum + ")", "i"), elemdisplay = {}, cssShow = { position: "absolute", visibility: "hidden", display: "block" }, cssNormalTransform = {
        letterSpacing: 0,
        fontWeight: 400
...
//# sourceMappingURL=jquery-1.8.2.js.map 
//# sourceMappingURL=jquery-1.8.2.js.map 
//# sourceMappingURL=jquery-1.8.2.js.map 
//# sourceMappingURL=jquery-1.8.2.js.map 
//# sourceMappingURL=jquery-1.8.2.js.map 
